<template>
  <div class="top-nav">
    ...
    <div class="right-menu">
      <span v-if="role === 'admin'">管理员：{{userName}}</span>
      <span v-else>普通用户：{{ userName }}</span>
...
import { apiSetApplication } from '@/api/modules/system'
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(['avatar', 'userName', 'role'])
  },
  mounted() {
